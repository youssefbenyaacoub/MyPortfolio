...
export const experiences = [
  {
    ...
    job: "Academic & Personal Projects",
    date: "2024 - Present",
    contents: [
      "Full-stack web application development: React, PHP, MySQL, Node.js.",
      "Creation of an integrated HR, accounting, and business management platform with a chatbot.",
      "Development of an 'old money' e-commerce site with cart, authentication, and admin panel.",
      "Creation of a professional website for the ESEN Library used by students.",
      "Complete project cycle management: design, database, UI/UX optimization."
    ]
  },
  {
    title: "Bachelor's in Computer Science for Management",
    job: "High School of Digital Economy (ESEN – La Manouba)",
    date: "2023 - 2026",
    contents: [
      "Specialization in web development, databases, and information systems."
    ]
  },
  {
    title: "Member & Media Lead",
    job: "Associations and Clubs",
    date: "2021 - Present",
    contents: [
      "Media lead at BIL LPM (1 year).",
      "Active member of Enactus Charguia.",
      "Organization of events such as TE-COMM 2024.",
      "Development of skills in leadership, communication, and team management."
    ]
  },
  {
    title: "Baccalaureate in Economics and Management",
    job: "Ibn Abi Dhief High School – Manouba, Tunisia",
    date: "2019 - 2023",
    contents: [
      "Training focused on economics, finance, accounting, and management."
    ]
  }
